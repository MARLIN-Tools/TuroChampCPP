...
- ModernSearch: Implements modern search features that don't change the evaluation but speed up the engine significantly. At depth 3 it will move after 50ms on my laptop.
